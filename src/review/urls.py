...
urlpatterns = [
    ...
    re_path(r'^unassigned/article/(?P<article_id>\d+)/assign/editor/(?P<editor_id>\d+)/type/(?P<assignment_type>[-\w.]+)/$',
        views.assign_editor, name='review_assign_editor'),
    re_path(r'^unassigned/article/(?P<article_id>\d+)/assign/senior_editor/(?P<senior_editor_id>\d+)/$',
        views.assign_senior_editor, name='review_assign_senior_editor'),
    ...
    re_path(r'^unassigned/article/(?P<article_id>\d+)/unassign/editor/(?P<editor_id>\d+)/$', views.unassign_editor,
        name='review_unassign_editor'),
    re_path(r'^unassigned/article/(?P<article_id>\d+)/unassign/senior_editor/(?P<senior_editor_id>\d+)/$', views.unassign_senior_editor,
        name='review_unassign_senior_editor'),
    re_path(r'^unassigned/article/(?P<article_id>\d+)/notify/editor/(?P<editor_id>\d+)/$', views.assignment_notification,
        name='review_assignment_notification'),
    re_path(r'^unassigned/article/(?P<article_id>\d+)/notify/senior_editor/(?P<senior_editor_id>\d+)/$', views.senior_assignment_notification,
        name='review_senior_assignment_notification'),
