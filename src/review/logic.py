...
def get_editors_candidates(article, user=None, editors_to_exclude=None):
    """ Builds a queryset of candidates for editor assignment for the given article
    ...
    """
    editor_assignments = article.editorassignment_set.filter()
    editor_pks_to_exclude = [assignment.editor.pk for assignment in editor_assignments]
